...
offers 0.7.1 while the 0.7.3 update is awaiting review. Both HTML pages also contain
...
- Chrome links to its published Web Store listing, currently on 0.7.1 while the 0.7.3 update is
  awaiting review.
